...
def about_us():
    tkinter.messagebox.showinfo('About Music', 'This is a music player build using Python Tkinter by Ritika batra')
...
rewindttn = ttk.Button(bottomframe, image=rewindphoto, command=rewind_music)
rewindttn.grid(row=0, column=0)
